...
public class SimpleDemoActivity extends AppCompatActivity {
    ...
    private Button mTienBtn;
    private Button mLuiBtn;
    private Button mTraiBtn;
    private Button mPhaiBtn;
    private Button mDungBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myWebView.loadUrl("http://192.168.43.147/stream.mjpg");
    }
    ...
    private void findViews() {
        ...
        mTienBtn = findViewById(R.id.send_tien);
        mLuiBtn = findViewById(R.id.send_lui);
        mTraiBtn = findViewById(R.id.send_trai);
        mPhaiBtn = findViewById(R.id.send_phai);
        mDungBtn = findViewById(R.id.send_dung);
    ...
    private void setListener() {
        ...
        mTienBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (!mManager.isConnect()) {
        ...
        mLuiBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (!mManager.isConnect()) {
                    Toast.makeText(getApplicationContext(), "Unconnected", LENGTH_SHORT).show();
        ...
        mTraiBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (!mManager.isConnect()) {
                    Toast.makeText(getApplicationContext(), "Unconnected", LENGTH_SHORT).show();
        ...
        mPhaiBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (!mManager.isConnect()) {
                    Toast.makeText(getApplicationContext(), "Unconnected", LENGTH_SHORT).show();
        ...
        mDungBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (!mManager.isConnect()) {
                    Toast.makeText(getApplicationContext(), "Unconnected", LENGTH_SHORT).show();
    ...
    private void logSend(final String log) {
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            new Handler(Looper.getMainLooper()).post(new Runnable() {
                @Override
                public void run() {
                    logSend(threadName + "(In Thread):" + log);
                }
            });
        }
    }
    ...
    private void logRece(final String log) {
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            new Handler(Looper.getMainLooper()).post(new Runnable() {
                @Override
                public void run() {
                    logRece(threadName + "(In Thread):" + log);
                }
            });
        }
